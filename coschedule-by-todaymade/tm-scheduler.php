...
if ( ! class_exists( 'tm_coschedule' ) ) {
    ...
    class TM_CoSchedule {
        ...
        public function activation() {
            ...
            // Recomendation from https://wearnhardt.com/2020/03/redirecting-after-plugin-activation/
            if (
            ...
            add_option( 'tm_coschedule_activation_redirect', wp_get_current_user()->ID );
        }
        ...
        public function activation_redirect() {
            ...
            // Ensure it is intended user
            if ( intval( get_option( 'tm_coschedule_activation_redirect', false ) ) === wp_get_current_user()->ID ) {
                ...
                if ( is_multisite() && is_network_admin() ) {
                    ...
                    $redirect_url = admin_url( 'admin.php?page=tm_coschedule_setup' );
                }
        ...
        public function add_menu() {
            if ( true === $this->connected ) {
              ...
              add_menu_page( 'CoSchedule', 'CoSchedule', 'manage_options', 'tm_coschedule_setup', array( $this, 'plugin_setup_page' ),
                $this->assets . '/plugin/img/icon.png',
                '50.505' );
            }
        }
        ...
        public function get_cache_bust() {
            ...
            if ( true === is_string( $response ) ) {
                $result = $response;
            } elseif ( true === is_array( $response ) && true === isset( $response['body'] ) && is_string( $response['body'] ) && $unix_length === strlen( $response['body'] ) ) {
