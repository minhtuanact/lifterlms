...
// -------------------------------------------------------------------
//
// Description : This is a command line script to generate DSGVOTCPDF fonts.
//
//============================================================+

/**
 * @file
 * This is a command line script to generate DSGVOTCPDF fonts.<br>
...
$tcpdf_include_dirs = array(realpath(dirname(__FILE__).'/../dsgdf.php'), '/usr/share/php/tcpdf/dsgdf.php', '/usr/share/tcpdf/dsgdf.php', '/usr/share/php-tcpdf/dsgdf.php', '/var/www/tcpdf/dsgdf.php', '/var/www/html/tcpdf/dsgdf.php', '/usr/local/apache2/htdocs/tcpdf/dsgdf.php');
...
function showHelp() {
	$help = <<<EOD
tcpdf_addfont - command line tool to convert fonts for the DSGVOTCPDF library.
...
echo "\n>>> Converting fonts for DSGVOTCPDF:\n";
