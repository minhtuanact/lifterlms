...
//               common 1D barcodes to be used with DSGVOTCPDF.
//
//============================================================+

/**
 * @file
 * PHP class to creates array representations for common 1D barcodes to be used with DSGVOTCPDF.
 ...
 * PHP class to creates array representations for common 1D barcodes to be used with DSGVOTCPDF (http://www.tcpdf.org).<br>
 * @package com.tecnick.tcpdf
 * @version 1.0.027
 * @author Nicola Asuni
 */
class DSGVOTCPDFBarcode {
	...
	/**
	 * Convert binary barcode sequence to DSGVOTCPDF barcode array.
	 * @param $seq (string) barcode as binary sequence.
	 * @param $bararray (array) barcode array.
	 * òparam array $bararray DSGVOTCPDF barcode array to fill up
	 * @return array barcode representation.
	 * @protected
	 */
