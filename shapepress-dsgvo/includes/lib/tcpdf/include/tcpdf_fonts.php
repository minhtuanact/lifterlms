...
// along with DSGVOTCPDF.  If not, see <http://www.gnu.org/licenses/>.
//
// See LICENSE.TXT file for more information.
// -------------------------------------------------------------------
//
// Description :Font methods for DSGVOTCPDF library.
//
//============================================================+

/**
 * @file
 * Unicode data and font methods for DSGVOTCPDF library.
 * @author Nicola Asuni
 ...
 * Font methods for DSGVOTCPDF library.
 * @package com.tecnick.tcpdf
 * @version 1.1.0
...
class DSGVOTCPDF_FONTS {
	 ...
	 * @return (string) DSGVOTCPDF font name or boolean false in case of error.
	 * @author Nicola Asuni
	 * @since 5.9.123 (2010-09-30)
	 * @public static
	 */
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		if (!DSGVOTCPDF_STATIC::file_exists($fontfile)) {
			// Could not find file
			return false;
		}
		// font metrics
		$fmetric = array();
		// build new font name for DSGVOTCPDF compatibility
		...
		if (@DSGVOTCPDF_STATIC::file_exists($outpath.$font_name.'.php')) {
		...
		$pfile = '<'.'?'.'php'."\n";
		$pfile .= '// DSGVOTCPDF FONT FILE DESCRIPTION'."\n";
	...
	public static function getFontFullPath($file, $fontdir=false) {
		...
		if (($fontdir !== false) AND @DSGVOTCPDF_STATIC::file_exists($fontdir.$file)) {
			$fontfile = $fontdir.$file;
		} elseif (@DSGVOTCPDF_STATIC::file_exists(self::_getfontpath().$file)) {
			$fontfile = self::_getfontpath().$file;
		} elseif (@DSGVOTCPDF_STATIC::file_exists($file)) {
			$fontfile = $file;
		}
		return $fontfile;
	}
