...
// DESCRIPTION :
//
// Class to create DataMatrix ECC 200 barcode arrays for DSGVOTCPDF class.
...
class Datamatrix {
	...
	/**
	 * Barcode array to be returned which is readable by DSGVOTCPDF.
	 * @protected
	 */
...
// -----------------------------------------------------------------------------
	...
	/**
	 * Returns a barcode array which is readable by DSGVOTCPDF
	 * @return array barcode array readable by DSGVOTCPDF;
	 * @public
	 */
