...
//
// Description :
//   Static methods used by the DSGVOTCPDF class.
//
//============================================================+

/**
 * @file
 * This is a PHP class that contains static methods for the DSGVOTCPDF class.<br>
...
class DSGVOTCPDF_STATIC {
	...
	/**
	 * Return the current DSGVOTCPDF version.
	 * @return DSGVOTCPDF version string
	 * @since 5.9.012 (2010-11-10)
	 * @public static
	 */
	public static function getDSGVOTCPDFVersion() {
		return self::$tcpdf_version;
	}

	/**
	 * Return the current DSGVOTCPDF producer.
	 * @return DSGVOTCPDF producer string
	 * @since 6.0.000 (2013-03-16)
	 * @public static
	 */
	public static function getDSGVOTCPDFProducer() {
		return "\x54\x43\x50\x44\x46\x20".self::getDSGVOTCPDFVersion()."\x20\x28\x68\x74\x74\x70\x3a\x2f\x2f\x77\x77\x77\x2e\x74\x63\x70\x64\x66\x2e\x6f\x72\x67\x29";
	}
	 ...
	 * @param $file_id (string) DSGVOTCPDF file_id.
...
} // END OF DSGVOTCPDF_STATIC CLASS
