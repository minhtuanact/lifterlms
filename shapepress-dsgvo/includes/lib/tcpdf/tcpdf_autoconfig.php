...
// -------------------------------------------------------------------
//
// Description : Try to automatically configure some DSGVOTCPDF
...
/**
 * @file
 * Try to automatically configure some DSGVOTCPDF constants if not defined.
...
// Load main configuration file only if the K_DSGVOTCPDF_EXTERNAL_CONFIG constant is set to false.
if (!defined('K_DSGVOTCPDF_EXTERNAL_CONFIG') OR !K_DSGVOTCPDF_EXTERNAL_CONFIG) {
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'DSGVOTCPDF');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'DSGVOTCPDF');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'DSGVOTCPDF Example');
}
...
if (!defined('K_DSGVOTCPDF_CALLS_IN_HTML')) {
	define('K_DSGVOTCPDF_CALLS_IN_HTML', true);
}

if (!defined('K_DSGVOTCPDF_THROW_EXCEPTION_ERROR')) {
	define('K_DSGVOTCPDF_THROW_EXCEPTION_ERROR', false);
}
