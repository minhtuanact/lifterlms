...
var popup_cover_containers = '#adminmenuback, #adminmenuwrap, #wpadminbar, .interface-interface-skeleton__header, .interface-interface-skeleton__secondary-sidebar, .interface-interface-skeleton__footer, .interface-interface-skeleton__sidebar';
jQuery(function() {
  ...
  /* Trigger click to close gutenberg sidebar menu when click on PG shortcode */
  jQuery(".media-modal-close", parent.document).on("click", function() {
