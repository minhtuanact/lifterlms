...
class WPRM_Admin_Menu {
	...
	public static function add_menu_page() {
		add_menu_page( 'WP Recipe Maker', 'WP Recipe Maker', WPRM_Settings::get( 'features_manage_access' ), 'wprecipemaker', array( 'WPRM_Manage', 'page_template' ), 'data:image/svg+xml;base64,' . self::$icon, '57.9' );
	}
