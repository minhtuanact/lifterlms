...
class Element implements \FSVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct($nps_id, $display_nps_decision, $element_id, $worst_label, $best_label, $question, $feedback_question, $disclaimer, $send_button, $send_button_sending, $write_key, $campaign_id, $feedback_id, $thank_you_message, $user_id_provider, $ajax_url)
    {
        $this->nps_id = $nps_id;
