 ...
 * @license     http://opensource.org/licenses/gpl-2.0.php GNU Public License
 * @since       5.2
 */var ei=n(121);function ti(e){var t=Array.from(e.querySelectorAll("td.column-shortcode"));t.length>0&&t.map((function(e){!function(e){e.addEventListener("click",(function(){document.execCommand("selectall",null,!1),document.execCommand("copy")}))}(e)}))}n(208);
/**
