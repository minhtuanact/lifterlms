    ...
    if (!class_exists('Inisev\Subs\InisevPlugPromo')) {
      ...
      class InisevPlugPromo {
        ...
        function __construct($file, $slug, $byName, $menu) {
          ...
          // Plugin assets
          $this->url = trailingslashit(plugins_url(null, $file)) . 'promotion/assets/';
        ...
        private function checkIfMPUAlt() {
          ...
          if ($body && array_key_exists('body', $body)) {
        ...
        public function addScriptsAndStyles() {
          ...
          if (defined('insPP_renderScripts')) {
            ...
            // Load styles & script
            wp_enqueue_script('inisev-promotion-script', ($this->url . 'script.min.js'), [], '0.1.0');
            wp_enqueue_style('inisev-promotion-style', ($this->url . 'style.min.css'), [], '0.1.0');
