...
wdi_front.createObject = function (obj, currentFeed) {
  ...
  if ( obj.type === 'image' ) {
    ...
    var media_standard_h = obj['carousel_media'][0]['images'] ? obj['carousel_media'][0]['images']['standard_resolution']['height'] : obj['carousel_media'][0]['videos']['standard_resolution']['height'] ;
    var media_standard_w = obj['carousel_media'][0]['images'] ? obj['carousel_media'][0]['images']['standard_resolution']['width'] : obj['carousel_media'][0]['videos']['standard_resolution']['width'] ;
  }
